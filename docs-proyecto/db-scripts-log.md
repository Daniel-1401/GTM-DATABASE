...
| 006_crear_asignaciones_organizacionales_y_referencias_posicion_sap | 2026-09-04T08:00:21-05:00 | `rrhh.AsignacionOrganizacional` | Historiar sede, área, cargo y posición SAP por relación laboral; un cargo puede repetirse, pero una posición SAP abierta corresponde a una sola asignación. | `db/migrations/nucleo/006_crear_asignaciones_organizacionales_y_referencias_posicion_sap.sql` |
...
| limpiar_datos_alimentacion | 2026-09-08T00:00:00-05:00 | 12 tablas de `[alimentacion]` | Eliminar datos del módulo y reiniciar sus identidades bajo confirmación explícita. No ejecutado contra SQL Server. | `db/data_prueba/limpieza/limpiar_datos_alimentacion.sql` |
| limpiar_datos_nucleo | 2026-09-08T00:00:00-05:00 | 15 tablas del núcleo | Eliminar datos del núcleo y reiniciar sus identidades bajo confirmación explícita, sin requerir que exista Alimentación. No ejecutado contra SQL Server. | `db/data_prueba/limpieza/limpiar_datos_nucleo.sql` |
