...
## Corpus Check
- 59 files · ~33,558 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 226 nodes · 174 edges · 54 communities (51 shown, 3 thin omitted)
...
Cohesion: 0.33
Nodes (5): Blockers, Entrega DB-ALIMENTACION-009-CORR-2, Estado de corrección, Gate Review — DB Alimentación, Warnings
...
## Knowledge Gaps
- **149 isolated node(s):** `Alcance`, `Secuencia reproducible`, `Reversión`, `Validación disponible sin instancia`, `Extensión del módulo Alimentación` (+144 more)
